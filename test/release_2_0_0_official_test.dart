...
void main() {
  ...
  group('v2.0.1 Quality Gate', () {
    test('pubspec.yaml version matches the centralized release contract', () {
      ...
      expect(content, contains('version: 2.0.5-beta.1+5'));
    ...
    test('Installer definition uses the stable display version', () {
      ...
      expect(content, contains('#define MyAppDisplayVersion "2.0.5-beta.1+5"'));
      expect(content, contains('#define MyAppVersion "2.0.5.5"'));
    });
